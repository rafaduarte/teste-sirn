...
class StoreUpdateRelatorioTerceiroTrimestre extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'faturamento_julho' => ['required'],
            'faturamento_agosto' => ['required'],
            'faturamento_setembro' => ['required'],
            'faturamento_upload' => ['required', 'mimes:pdf', 'max:5120'],
            'empregos_gerados_trimestre_julho' => ['required', 'numeric'],
            'empregos_gerados_trimestre_agosto' => ['required', 'numeric'],
            'empregos_gerados_trimestre_setembro' => ['required', 'numeric'],
            ...
            'icms_total_devido_julho' => ['required'],
            'icms_total_devido_agosto' => ['required'],
            'icms_total_devido_setembro' => ['required'],
            'icms_total_devido_upload' => ['required', 'mimes:pdf' , 'max:5120'],
            'icms_total_pago_julho' => ['required'],
            'icms_total_pago_agosto' => ['required'],
            'icms_total_pago_setembro' => ['required'],
            ...
            'investimento_realizado_julho' => ['required'],
            'investimento_realizado_agosto' => ['required'],
            'investimento_realizado_setembro' => ['required'],
