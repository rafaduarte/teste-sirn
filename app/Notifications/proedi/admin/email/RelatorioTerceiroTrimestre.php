...
class RelatorioTerceiroTrimestre extends Notification implements ShouldQueue
{
    use Queueable;
     ...
     * @return void
     */
    public function __construct(EnviarRelatorioTerceiroTrimestre $enviarRelatorio)
    {
