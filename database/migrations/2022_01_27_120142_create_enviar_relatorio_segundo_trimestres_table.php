...
class CreateEnviarRelatorioSegundoTrimestresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('enviar_relatorio_segundo_trimestres', function (Blueprint $table) {
            ...
            $table->decimal('faturamento_abril',18,2);
            $table->decimal('faturamento_maio',18,2);
            $table->decimal('faturamento_junho',18,2);
            $table->string('faturamento_upload');
            $table->string('empregos_gerados_trimestre_abril');
            $table->string('empregos_gerados_trimestre_maio');
            $table->string('empregos_gerados_trimestre_junho');
            ...
            $table->decimal('icms_total_devido_abril',18,2);
            $table->decimal('icms_total_devido_maio',18,2);
            $table->decimal('icms_total_devido_junho',18,2);
            $table->string('icms_total_devido_upload');
            $table->decimal('icms_total_pago_abril',18,2);
            $table->decimal('icms_total_pago_maio',18,2);
            $table->decimal('icms_total_pago_junho',18,2);
            $table->string('icms_total_pago_upload');
            $table->decimal('investimento_projetado',18,2);
            $table->string('investimento_projetado_upload');
            $table->decimal('investimento_realizado_abril',18,2);
            $table->decimal('investimento_realizado_maio',18,2);
            $table->decimal('investimento_realizado_junho',18,2);
    ...
    {
        Schema::dropIfExists('enviar_relatorio_segundo_trimestres');
    }
}
