...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a>Relatório do 4º Trimestre do PROEDI</a></li>
    </ol>
 
<form action="{{ route('reports.proedi.fourth.trimestre') }}">
...
<div class="card" style="width: 2800px">   
    <div style="width: 50px">
        @include('admin.reports.proedi.quarto_trimestre.table', $trimestres)
    </div>
