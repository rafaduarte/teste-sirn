...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a>Relatório do 2º Trimestre do PROEDI</a></li>
    </ol>
 
<form action="{{ route('reports.proedi.second.trimestre') }}">
...
<div class="card" style="width: 2800px">   
    <div style="width: 50px">
        @include('admin.reports.proedi.segundo_trimestre.table', $trimestres)
    </div>
