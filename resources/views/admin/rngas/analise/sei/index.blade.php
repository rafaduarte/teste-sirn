...
@section('content_header')
    ...
    <h1><strong>Processos no SEI RN Mais Gás</strong> <a href="{{ route('rngas.sei.create')}}" class="btn btn-dark"><i class="fas fa-plus-square"></i>  ADD </a></h1>
@stop
                ...
                <table class="table table-condensed">
                    ...
                    <tr>
                        ...
                        <td><a  class="btn btn-warning" href="{{$key->link}}">Visualizar</a></td>
                            <td style="width=10px">
                                <form action="{{ route('rngas.sei.destroy', $key->id)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
