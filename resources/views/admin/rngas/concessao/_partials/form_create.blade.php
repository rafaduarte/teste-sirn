...
<div class="form-group">
    <label>* Instrumento constitutivo da empresa e eventuais alterações ou do contrato social consolidado</label>
    <input  type="file" name="instrumento_constitutivo" class="form-control">
</div>
<div class="form-group">
    <label>* Procuração</label>
    <input  type="file" name="procuracao" class="form-control">
</div>
<div class="form-group">
    <label>* Contrato Social e Aditivos</label>
    <input  type="file" name="contrato_social_aditivos" class="form-control">
</div>
<div class="form-group">
    <label>* Cartão CNPJ</label>
    <input  type="file" name="cartao_cnpj" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    <button type="submit" class="btn btn-dark" onclick="this.disabled=true;this.form.submit();">Próximo</button> 
</div>