...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{ route('proedi.concessao.index')}}">RNGás+</a></li>
    </ol>

    <h1>Pedir Concessão do RNGás+ <a href="{{ route('rngas.concessao.create')}}" class="btn btn-dark"><i class="fas fa-plus-square"></i> ADD</a></h1>
@stop
        ...
        <div class="card-body">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td  style="width=10px">
                                <a href="{{ route('show.rngas.admin', $pedido->id)}}" class="btn btn-warning">Ver</a>
                                @if ($pedido->editar == true)
                                <a href="{{ route('rngas.concessao.edit', $pedido->id)}}"  class="btn btn-primary">Editar</a>
                                @endif
                               ...
                               <h6><strong>Permissão para editar enviada</strong></h6>
                                ...
                                <a href="{{ route('rngas.pedir.atualizar', $pedido->id)}}"  class="btn btn-primary">Autorização para editar</a>
                                @endif               
