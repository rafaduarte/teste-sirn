...
@section('content_header')
    <h1>Possui Requerimento Atualizado Assinado?</h1>
@stop

@section('content_header')
    <h4>Possui Requerimento Assinado?</h4>
@stop
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          ...
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">               
                <div class="card-body">
                    <h3>Edite Somente Os Campos Necessários</h3>
                    <form action="{{ route('rngas.atualizar') }}" class="form" method="POST" enctype="multipart/form-data">
                        @csrf
                        @include('admin.rngas.concessao._partials.form_edit')
                    </form>
                </div>
            </div>
