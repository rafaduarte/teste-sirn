...
<html>
    ...
    <body>        
        <div>
            ...
            <caption><h4 id="titulo">REQUERIMENTO PARA CONCESSÃO</h4></caption>
        ...
        <div>
            ...
            <table>
                ...
                <body>
                    <div>
                       <hr> <caption><img id="form" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/form.png'))) }}"  alt=""></caption><br>
