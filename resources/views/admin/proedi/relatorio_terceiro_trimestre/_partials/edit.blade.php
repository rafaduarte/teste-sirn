...
<div class="form-group">
    ...
    <input style="width: 100%; border-style: outset" type="text" class="money"name="faturamento_julho" value="{{ $relatorio->faturamento_julho }}" placeholder="Faturamento em Julho" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money"name="faturamento_agosto" value="{{ $relatorio->faturamento_agosto }}" placeholder="Faturamento em Agosto" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money"name="faturamento_setembro" value="{{ $relatorio->faturamento_setembro }}" placeholder="Faturamento em Setembro" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="text" name="empregos_gerados_trimestre_julho" value="{{ $relatorio->empregos_gerados_trimestre_julho }}" placeholder="Quantidade de Empregos Gerados em Julho" class="form-control">
    <input type="text" name="empregos_gerados_trimestre_agosto" value="{{ $relatorio->empregos_gerados_trimestre_agosto }}" placeholder="Quantidade de Empregos Gerados em Agosto" class="form-control">
    <input type="text" name="empregos_gerados_trimestre_setembro" value="{{ $relatorio->empregos_gerados_trimestre_setembro }}" placeholder="Quantidade de Empregos Gerados em Setembro" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_devido_julho" value="{{ $relatorio->icms_total_devido_julho }}" placeholder="ICMS total devido em Julho" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_devido_agosto" value="{{ $relatorio->icms_total_devido_agosto }}" placeholder="ICMS total devido em Agosto" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_devido_setembro" value="{{ $relatorio->icms_total_devido_setembro }}" placeholder="ICMS total devido em Setembro" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_pago_julho" value="{{ $relatorio->icms_total_pago_julho }}" placeholder="ICMS total pago em julho" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_pago_agosto" value="{{ $relatorio->icms_total_pago_agosto }}" placeholder="ICMS total pago em agosto" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_pago_setembro" value="{{ $relatorio->icms_total_pago_setembro }}" placeholder="ICMS total pago em setembro" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input style="width: 100%; border-style: outset" type="text" class="money" name="investimento_realizado_julho" value="{{ $relatorio->investimento_realizado_julho }}" placeholder="Investimento realizado em Julho" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="investimento_realizado_agosto" value="{{ $relatorio->investimento_realizado_agosto }}" placeholder="Investimento realizado em Agosto" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="investimento_realizado_setembro" value="{{ $relatorio->investimento_realizado_setembro }}" placeholder="Investimento realizado em Setembro" class="form-control">
</div>
<div class="form-group">
