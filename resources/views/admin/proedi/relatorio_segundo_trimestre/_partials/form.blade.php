...
<div class="form-group">
    ...
    <input style="width: 100%; border-style: outset" type="text" class="money" name="faturamento_abril" placeholder="Faturamento Abril" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="faturamento_maio" placeholder="Faturamento Maio" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="faturamento_junho" placeholder="Faturamento Junho" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="text" name="empregos_gerados_trimestre_abril" placeholder="Quantidade de Empregos Gerados em Abril" class="form-control">
    <input type="text" name="empregos_gerados_trimestre_maio" placeholder="Quantidade de Empregos Gerados em Maio" class="form-control">
    <input type="text" name="empregos_gerados_trimestre_junho" placeholder="Quantidade de Empregos Gerados em Junho" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_devido_abril" placeholder="ICMS total devido em Abril" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_devido_maio" placeholder="ICMS total devido em Maio" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_devido_junho" placeholder="ICMS total devido em Junho" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_pago_abril" placeholder="ICMS total pago em Abril" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_pago_maio" placeholder="ICMS total pago em Maio" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_pago_junho" placeholder="ICMS total pago em Junho" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input style="width: 100%; border-style: outset" type="text" class="money" name="investimento_realizado_abril" placeholder="Investimento realizado em Abril" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="investimento_realizado_maio" placeholder="Investimento realizado em Maio" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="investimento_realizado_junho" placeholder="Investimento realizado em Junho" class="form-control">
</div>
<div class="form-group">
