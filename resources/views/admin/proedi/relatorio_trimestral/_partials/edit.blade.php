...
<div class="form-group" id="mycheckboxdiv_placa_proedi" style="display: none">
    ...
    <input type="file" name="placa_proedi_upload" value="{{ $relatorio->placa_proedi_upload }}" class="form-control">
</div>
<div class="form-group">
    <label>Faturamento da Empresa até 31/03</label>
    <input style="width: 100%; border-style: outset" type="text" class="money" name="faturamento_janeiro" value="{{ $relatorio->faturamento_janeiro }}" placeholder="Faturamento em Janeiro" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="faturamento_fevereiro" value="{{ $relatorio->faturamento_fevereiro }}" placeholder="Faturamento em Fevereiro" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="faturamento_marco" value="{{ $relatorio->faturamento_marco }}" placeholder="Faturamento em Março" class="form-control">
</div>
<div class="form-group">
    <label>Anexe O Comprovante do Faturamento Até 31/03</label>
    <input type="file" name="faturamento_upload" value="{{ $relatorio->faturamento_upload}}" class="form-control">
</div>
<div class="form-group">
    <label>Número de Empregos Diretos Gerados até 31/03</label>
    <input type="text" name="empregos_gerados_trimestre_janeiro" value="{{ $relatorio->empregos_gerados_trimestre_janeiro }}" placeholder="Quantidade de Empregos Gerados em Janeiro" class="form-control">
    <input type="text" name="empregos_gerados_trimestre_fevereiro" value="{{ $relatorio->empregos_gerados_trimestre_fevereiro }}" placeholder="Quantidade de Empregos Gerados em Fevereiro" class="form-control">
    <input type="text" name="empregos_gerados_trimestre_marco" value="{{ $relatorio->empregos_gerados_trimestre_marco }}" placeholder="Quantidade de Empregos Gerados em Março" class="form-control">
</div>
<div class="form-group">
    <label>Anexe O Comprovante Com o Número de Empregos Diretos Gerados Até 31/03</label>
    <input type="file" name="empregos_gerados_trimestre_upload" value="{{ $relatorio->empregos_gerados_trimestre_upload }}" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="file" name="empregos_gerados_proedi_upload" value="{{ $relatorio->empregos_gerados_proedi_upload }}" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_devido_janeiro" value="{{ $relatorio->icms_total_devido_janeiro }}" placeholder="ICMS total devido em Janeiro" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_devido_fevereiro" value="{{ $relatorio->icms_total_devido_fevereiro }}" placeholder="ICMS total devido em Fevereiro" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_devido_marco" value="{{ $relatorio->icms_total_devido_marco }}" placeholder="ICMS total devido em Março" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_pago_janeiro" value="{{ $relatorio->icms_total_pago_janeiro }}" placeholder="ICMS total pago em Janeiro" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_pago_fevereiro" value="{{ $relatorio->icms_total_pago_fevereiro }}" placeholder="ICMS total pago em Fevereiro" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="icms_total_pago_marco" value="{{ $relatorio->icms_total_pago_marco }}" placeholder="ICMS total pago em Março" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input style="width: 100%; border-style: outset" type="text" class="money" name="investimento_realizado_janeiro" value="{{ $relatorio->investimento_realizado_janeiro }}" placeholder="Investimento realizado em Janeiro" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="investimento_realizado_fevereiro" value="{{ $relatorio->investimento_realizado_fevereiro }}" placeholder="Investimento realizado em Fevereiro" class="form-control">
    <input style="width: 100%; border-style: outset" type="text" class="money" name="investimento_realizado_marco" value="{{ $relatorio->investimento_realizado_marco }}" placeholder="Investimento realizado em Março" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <textarea name="destino_mercadoria" value="{{ $relatorio->destino_mercadoria }}"  cols="30" rows="4" placeholder=" Ex.: 50% RN, 10% PB, 5% CE, 35% Exportação" class="form-control">{{ $relatorio->destino_mercadoria }}</textarea>
</div>
<div class="form-group">
