        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          ...
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">               
                <div class="card-body">
                    <h3>Fazer Pedido de Concessão</h3>
                    <form action="{{ route('proedi.concessao.store') }}" class="form" method="POST" enctype="multipart/form-data">
                        @csrf
                        @include('admin.proedi.concessao._partials.form')
                    </form>
                </div>
            </div>
            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                <div class="card-body">
                    ...
                    <form action="{{ route('requerimento.proedi.download') }}" class="form" method="POST" enctype="multipart/form-data">
                        @csrf
                        @include('admin.proedi.concessao._partials.requerimento_form')
                    </form>
                </div>
            </div>
          </div> 
