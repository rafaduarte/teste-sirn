        ...
        <div class="card-body">
            <ul>
                <li>
                  ...
                  <li><strong>Nome do Projetista:</strong> {{$pedido->nome_projetista}}</li>
                  <li><strong>CPF do Projetista:</strong> {{$pedido->cpf_projetista}}</li>
                  <li><strong>Telefone do Projetista:</strong> {{$pedido->telefone_projetista}}</li>
                  <li><strong>Endereço do Projetista:</strong> {{$pedido->endereco_projetista}}</li>
                  <li><strong>Município do Projetista:</strong> {{$pedido->municipio_projetista}}</li>
                  <li><strong>UF do Projetista:</strong> {{$pedido->uf_projetista}}</li>
                  <li>
                    <strong>Documento do Projetista com Foto</strong>
                    <form action="{{ route('proedi.concessao.file', $pedido->documento_projetista)}}" method="get">
                        @csrf
