...
<div class="form-group">
    ...
    <input type="file" name="carta_motivos" value="{{$pedido->carta_motivos }}" class="form-control">
</div>
...
<div class="form-group" id="mycheckboxdiv_mudanca_local" style="display:none">
    ...
    <input type="file" name="mudanca_local" value="{{$pedido->mudanca_local }}" class="form-control">
</div>

<div class="form-group" id="mycheckboxdiv_faturamento" style="display:none">
    <label> Aumento de Faturamento</label>
    <input type="file" name="faturamento" value="{{$pedido->faturamento }}" class="form-control">
</div>

<div class="form-group" id="mycheckboxdiv_empregados" style="display:none">
    <label>  Aumento de Empregados</label>
    <input type="file" name="empregados" value="{{$pedido->empregados }}" class="form-control">
</div>
...
<div class="form-group" id="mycheckboxdiv_materia_prima" style="display:none">
    ...
    <input type="file" name="materia_prima" value="{{$pedido->materia_prima }}" class="form-control">
</div>
...
<div class="form-group" id="mycheckboxdiv_investimento_ped" style="display:none">
    ...
    <input type="file" name="investimento_ped" value="{{$pedido->investimento_ped }}" class="form-control">
</div>
...
<div class="form-group" id="mycheckboxdiv_investimento_conservacao" style="display:none">
    ...
    <input type="file" name="investimento_conservacao" value="{{$pedido->investimento_conservacao }}" class="form-control">
</div>
...
<div class="form-group" id="mycheckboxdiv_investimento_mao_obra" style="display:none">
    ...
    <input type="file" name="investimento_mao_obra" value="{{$pedido->investimento_mao_obra }}" class="form-control">
</div>
